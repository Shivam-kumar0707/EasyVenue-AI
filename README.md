...
- **Testing**: A full suite of 26 tests is implemented in Vitest (under `tests/`), testing input validation edge cases, anomaly threshold logic, classification fallbacks, sparkline path generation, history trimming, announcement drafting, and input sanitization logic.
